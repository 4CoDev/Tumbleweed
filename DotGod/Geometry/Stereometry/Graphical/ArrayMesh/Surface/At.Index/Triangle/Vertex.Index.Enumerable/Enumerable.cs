using DotGod.Geometry.Stereometry.Graphical.Vertex.Index.Enumerable;
using Tumbleweed.Scalar.Immutable;

namespace DotGod.Geometry.Stereometry.Graphical.ArrayMesh.Surface.At.Index.Triangle.Vertex.Index.Enumerable;
