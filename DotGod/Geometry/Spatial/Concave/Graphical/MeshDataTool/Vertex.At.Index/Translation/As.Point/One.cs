namespace DotGod.Geometry.Spatial.Concave.Graphical.MeshDataTool.Vertex.At.Index.Translation.As.Point;

public sealed class One : Tumbleweed.Point.Spatial.Envelope<Tumbleweed.Number.Real.Any>
{
	public One
	(
