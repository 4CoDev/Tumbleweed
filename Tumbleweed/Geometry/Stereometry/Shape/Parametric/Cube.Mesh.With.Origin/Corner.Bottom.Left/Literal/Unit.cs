...
using Tumbleweed.Geometry.Stereometry.Shape.Mesh.Convex.With.Vertex.Translation.Array;
using Point = Tumbleweed.Point.Spatial.Real.Base.Binary.Precision.Single;

namespace Tumbleweed.Geometry.Stereometry.Shape.Parametric.Cube.Mesh.With.Origin.Corner.Bottom.Left.Literal;
