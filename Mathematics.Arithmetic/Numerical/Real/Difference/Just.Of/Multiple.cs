...
namespace Tumbleweed.Mathematics.Arithmetic.Numerical.Real.Difference.Just.Of;
	...
	(
		new One(
			new Number.Real.Binary.Precision.Single.System.Arithmetics.Difference(
				new Number.Real.Binary.Precision.Single.System.From.Tumbleweed.Multiple(real)))
	)
	{
	}
}